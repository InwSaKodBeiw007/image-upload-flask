...
## Phase 3.1: Setup
- [ ] T001 Create project folder structure: `backend/src/app.py`, `backend/src/config.py`, `backend/src/blueprints/main.py`, `backend/src/blueprints/api.py`, `backend/src/models/image.py`, `backend/src/services/image_service.py`, `backend/instance/images.db`, `backend/uploads/`, `backend/requirements.txt`, `backend/.env`, `frontend/static/css/`, `frontend/static/js/`, `frontend/templates/index.html`, `frontend/templates/image_detail.html`
- [ ] T002 Set up Python virtual environment in `.venv` folder
- [ ] T003 Install Flask and required dependencies via `pip` using `requirements.txt`
- [ ] T004 Create `.env` file with `SECRET_KEY`, `UPLOAD_FOLDER`, `MAX_CONTENT_LENGTH`, `SQLALCHEMY_DATABASE_URI`, `FLASK_ENV`
- [ ] T005 Initialize SQLite database (`instance/images.db`) and create tables

## Phase 3.2: Tests First (TDD) ⚠️ MUST COMPLETE BEFORE 3.3
**CRITICAL: These tests MUST be written and MUST FAIL before ANY implementation**
- [ ] T006 [P] Contract test POST /api/upload in `backend/tests/contract/test_api_upload.py`
- [ ] T007 [P] Contract test GET /api/images in `backend/tests/contract/test_api_images_list.py`
- [ ] T008 [P] Contract test GET /api/images/<id> in `backend/tests/contract/test_api_images_get.py`
- [ ] T009 [P] Contract test DELETE /api/images/<id> in `backend/tests/contract/test_api_images_delete.py`
- [ ] T010 [P] Contract test GET /health in `backend/tests/contract/test_api_health.py`
- [ ] T011 [P] Integration test: Python client uploads image successfully in `backend/tests/integration/test_upload_success.py`
- [ ] T012 [P] Integration test: Web gallery displays images and metadata in `frontend/tests/integration/test_gallery_display.py`
- [ ] T013 [P] Integration test: Web gallery sorts images by upload date in `frontend/tests/integration/test_gallery_sort.py`
- [ ] T014 [P] Integration test: Invalid/corrupted image upload handling in `backend/tests/integration/test_upload_invalid.py`
- [ ] T015 [P] Integration test: Concurrent uploads handling in `backend/tests/integration/test_concurrent_uploads.py`
- [ ] T016 [P] Integration test: Image exceeding size limit handling in `backend/tests/integration/test_upload_size_limit.py`

## Phase 3.3: Core Implementation (ONLY after tests are failing)
- [ ] T017 [P] Implement Image model in `backend/src/models/image.py`
- [ ] T018 [P] Implement Flask application factory in `backend/src/app.py`
- [ ] T019 [P] Implement configuration in `backend/src/config.py`
- [ ] T020 [P] Implement API Blueprint in `backend/src/blueprints/api.py`
- [ ] T021 [P] Implement Main Blueprint in `backend/src/blueprints/main.py`
- [ ] T022 Implement Image upload endpoint (POST /api/upload) in `backend/src/blueprints/api.py`
- [ ] T023 Implement List images endpoint (GET /api/images) in `backend/src/blueprints/api.py`
- [ ] T024 Implement Get image metadata endpoint (GET /api/images/<id>) in `backend/src/blueprints/api.py`
- [ ] T025 Implement Delete image endpoint (DELETE /api/images/<id>) in `backend/src/blueprints/api.py`
- [ ] T026 Implement Health check endpoint (GET /health) in `backend/src/blueprints/api.py`
- [ ] T027 Implement Serve image files endpoint (GET /uploads/<date>/<filename>) in `backend/src/blueprints/main.py`
- [ ] T028 [P] Implement Image service for file operations and metadata handling in `backend/src/services/image_service.py`
- [ ] T029 [P] Implement HTML templates (`frontend/templates/index.html`, `frontend/templates/image_detail.html`)
